  ...
  if(locations[i][3] == 'attach') {
      var custom_icon = {
          url: '/wp-content/themes/lemco/assets/img/marker-red.png', // url
          scaledSize: new google.maps.Size(30, 30), // scaled size
        }
    } else if(locations[i][3] == 'truck') {
      var custom_icon = {
          url: '/wp-content/themes/lemco/assets/img/marker-blue.png', // url
        scaledSize: new google.maps.Size(30, 30), // scaled size
            }
      } else {
        var custom_icon = {
        url: '/wp-content/themes/lemco/assets/img/marker-purple.png', // url
        scaledSize: new google.maps.Size(30, 30), // scaled size
        }
      }
    ...
    google.maps.event.addListener(marker, 'click', (function(marker, i) {
      return function() {
        infowindow.setContent('<strong>'+locations[i][0]+'</strong><p>'+locations[i][5]+'</p>Call: <a style="color:#ffbb00;font-weight:bold" href="tel:'+locations[i][4]+'">'+locations[i][4]+'</a>');
