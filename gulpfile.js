...
// Project related.
var project                 = 'Lemco Hydraulics'; // Project Name.
var projectURL              = 'lemco.local'; // Project URL. Could be something like localhost:8888.
...
// Style related.
var styleSRC                = ['./assets/scss/style.scss','./assets/scss/editor-style.scss', './assets/scss/print.scss']; // Path to main .scss file.
...
var imagesDestination       = './assets/img/optimized'; // Destination folder of optimized images. Must be different from the imagesSRC folder.
